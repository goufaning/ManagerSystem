...
<script type="text/javascript">
    function save() {
        ...
        $.ajax({
            ...
            dataType: "json",
            url: "${pageContext.request.contextPath}/OutWarehouseServlet",//传入后台的地址/方法
...
<div id="a" class="div_rigth">
    <label class="title"><a href="manager.jsp"><p class="back">&lt;&nbsp;返回</p></a> <span>出库管理</span></label>
    <hr />
    <div class="work_area">
        <div id="work">
            <div class="work">
            ...
            <button id="in_button" class="mybtn" onclick="save();">出库</button>
        </div>
    </div>
</div>